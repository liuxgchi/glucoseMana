...
public class PreferencesUtils {
	...
	/**
	 * 
	* @descrption 清除特定sp的内容
	* @author lxc   
	* @version 创建时间：2014年12月18日 下午5:10:10
	 */
	public static void clearObject(Context context,Class<?> cls){
		...
		SharedPreferences sp = context.getSharedPreferences(object.getClass().getSimpleName().toLowerCase(), context.MODE_WORLD_WRITEABLE);//1:read 2:write
	...
	public static Object getObjectFromSp(Context mContext, Class<?> classzz) throws InstantiationException, IllegalAccessException{
		...
		SharedPreferences sp = mContext.getSharedPreferences(classzz.getSimpleName().toLowerCase(), 1);//1:read 2:write
		Field[] fields = object.getClass().getDeclaredFields();
		for(Field field : fields){
			try {
    ...
    public static String PREFERENCE_NAME = "XingAndroidCommon";
